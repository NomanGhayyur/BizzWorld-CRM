...
const TotalExpense = ({ style, otherdata }: ComponentProps) => {
  const Tdata = otherdata?.otherexpense;
        ...
        <div className="col-lg-12">
          <div style={{ marginBottom: "0.5rem", display: "flex" }}>
            ...
            <div className="col-lg-6">
              ...
              >
                Rs{" "}
                {currencyFormat(parseInt(otherdata?.sumallexpense?.grandtotal))}
              </h5>
            </div>
          </div>
        </div>
