...
import { pickOrder } from '../../../api/pick';
...
const ForwardedOrder: NextPage = () => {
  ...
  const [orderstatus, setOrderStatus] = useState<number | string>(2);
  ...
  const {
    ...
    [`OrderList_${brandID}`, brandID, page],
  ...
  const columns = useMemo(() => {
    ...
    return temp;
  }, [user, filterText, onRestore, onPick, onEdit]);
