...
import styles from "../autolead/autolead.module.css";
...
const colorObject: any = {
  Client: "#FED7D7",
  Cancel: "#CCEBC8",
  "Pick By Sales": "#82d7fa",
  "Forwarded To Sales": "#83b4fa",
};

const ManualLeadList = React.memo<propTypes>((props) => {
  ...
  const [leadtype, setleadType] = useState<number | string>(2);
  ...
  const {
    ...
    [`ManualLeadList_${brandID}`, brandID, page],
