...
import styles from "./clientlead.module.css";
import Card from "../../components/shared/Card";
import { useDispatch, useSelector } from "react-redux";
import { AppThunkDispatch, RootState } from "../../redux/types";
import moment from "moment";
import { useQuery } from "react-query";
import { deleteLead, getLeadList, getforwardedLeadList } from "../../api/lead";
...
const Clients = React.memo<propTypes>((props) => {
  ...
  const [leadstatus, setleadStatus] = useState<number | string>(3);
  ...
  const {
    ...
    [`ClientLeadList_${brandID}`, brandID, page],
      ...
      >
        <div className="row">
          <div className="col-lg-2">
            <h4 style={{ fontWeight: "bold", fontSize: "16px" }}>Clients</h4>
          </div>
