...
import Approved from "../../../../public/icons/invoicesent.svg";
...
const EditFixed: NextPage = () => {
  ...
  const [orderstatus, setOrderStatus] = useState<number | string>(10);
      ...
      temp.push({
        ...
        render: (v: any) => (
          <>
            ...
            >
              <Image src={Approved} alt="Alt" width={"25px"} />
            </span>
          </>
        ),
      });
  ...
  const modalColumns = useMemo(() => {
    ...
    return temp;
  }, [user, filterText, onOrderEditbyClient, onOrderCancel, onOrderApproved]);
      ...
      >
        <div className="row" style={{}}>
          <div className="col-lg-2">
            <h4 style={{ fontWeight: "bold", fontSize: "16px" }}>Edit Fixed</h4>
          </div>
