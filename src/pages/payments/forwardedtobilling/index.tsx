...
import toPaid from "../../../../public/icons/paid.svg";
...
const PaymentInvoiceSent: NextPage = () => {
  ...
  const [paymentstatus, setPaymentStatus] = useState<number | string>(8);
  ...
  const columns = useMemo(() => {
    const temp = [
      ...
      },
      {
        ...
        sortIndex: "orderpaymentstatus_name",
      },
      {
        label: "Amount",
...
export default PaymentInvoiceSent;
